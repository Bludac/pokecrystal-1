...
INCBIN "gfx/pokemon/arcalight/front.gbcpal", middle_colors
INCLUDE "gfx/pokemon/arcalight/shiny.pal"
INCBIN "gfx/pokemon/freezing/front.gbcpal", middle_colors
INCLUDE "gfx/pokemon/freezing/shiny.pal"
