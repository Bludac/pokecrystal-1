...
FalknerGroup:
	...
	db  13, HOOTHOOT
		dw LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP
		db BERRY, PECK, HYPNOSIS, FURY_ATTACK, NIGHT_SHADE
	db  13, SPEAROW
		dw LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP
		db SHARP_BEAK, PECK, FURY_ATTACK, PURSUIT, FOCUS_ENERGY
	db  13, NATU
		dw LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP
		db BERRY, CONFUSION, LIGHT_SCREEN, GUST, MUD_SLAP
	db  13, PIDGEOTTO
		dw LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP
		db MINT_BERRY, AIR_CUTTER, SWAGGER, QUICK_ATTACK, MUD_SLAP
	db -1 ; end

WhitneyGroup:
	; WHITNEY (1)
	db "WHITNEY@", TRAINERTYPE_MOVES
	db 18, CLEFAIRY,   FURY_ATTACK, POUND, ENCORE, METRONOME
	db 20, MILTANK,    ROLLOUT, ATTRACT, HEADBUTT, RECOVER
	db -1 ; end
...
BugsyGroup:
	...
	db 18, SHUCKLE
		dw LV20_STAT_EXP, LV20_STAT_EXP, LV20_STAT_EXP, LV20_STAT_EXP, LV20_STAT_EXP
		db BERRY_JUICE, SPIKES, REST, TOXIC, PROTECT
	db 18, YANMA
		dw LV20_STAT_EXP, LV20_STAT_EXP, LV20_STAT_EXP, LV20_STAT_EXP, LV20_STAT_EXP
		db FOCUS_SASH, PROTECT, TWISTER, SONICBOOM, STRUGGLE_BUG
	db 16, BEEDRILL
		dw LV20_STAT_EXP, LV20_STAT_EXP, LV20_STAT_EXP, LV20_STAT_EXP, LV20_STAT_EXP
		db BERRY_JUICE, VICEGRIP, POISON_TAIL, COUNTER, SCARY_FACE
	db 16, BUTTERFREE
		dw LV20_STAT_EXP, LV20_STAT_EXP, LV20_STAT_EXP, LV20_STAT_EXP, LV20_STAT_EXP
		db BERRY_JUICE, STRUGGLE_BUG, CONFUSION, MIRROR_COAT, SCARY_FACE
	db 18, SCYTHER
		dw LV20_STAT_EXP, LV20_STAT_EXP, LV20_STAT_EXP, LV20_STAT_EXP, LV20_STAT_EXP
		db BERRY_JUICE, FURY_CUTTER, ICE_SHARD, PURSUIT, LEER
	db -1 ; end

MortyGroup:
	; MORTY (1)
	db "MORTY@", TRAINERTYPE_MOVES
	db 21, GASTLY,     LICK, TOXIC, MEAN_LOOK, CURSE
	db 21, HAUNTER,    HYPNOSIS, SHADOW_BALL, CURSE, NIGHT_SHADE
	db 25, GENGAR,     HYPNOSIS, SHADOW_BALL, MEAN_LOOK, DREAM_EATER
	db 23, HAUNTER,    TOXIC, MEAN_LOOK, SHADOW_BALL, NIGHT_SHADE
	db -1 ; end
...
JasmineGroup:
	...
	db 30, MAGNEMITE,  THUNDERBOLT, CONFUSE_RAY, SONICBOOM, THUNDER_WAVE
	db 30, MAGNEMITE,  THUNDERBOLT, CONFUSE_RAY, SONICBOOM, THUNDER_WAVE
...
ChuckGroup:
	...
	db 30, POLIWRATH,  HYPNOSIS, FORESIGHT, SURF, DYNAMICPUNCH
	db -1 ; end
...
ClairGroup:
	...
	db 40, KINGDRA,    LEER, SURF, HYPER_BEAM, DRAGONBREATH
	db -1 ; end
...
Rival1Group:
	...
	db 20, HAUNTER,    LICK, TOXIC, MEAN_LOOK, CURSE
	db 18, MAGNEMITE,  POUND, THUNDERSHOCK, CONFUSE_RAY, SONICBOOM
	...
	db 18, MAGNEMITE,  POUND, THUNDERSHOCK, CONFUSE_RAY, SONICBOOM
	db 20, ZUBAT,      LEECH_LIFE, CONFUSE_RAY, BITE, CONFUSE_RAY
	db 22, QUILAVA,    LEER, POUND, EMBER, QUICK_ATTACK
	db -1 ; end
	...
	db 18, MAGNEMITE,  POUND, THUNDERSHOCK, CONFUSE_RAY, SONICBOOM
	db 20, ZUBAT,      LEECH_LIFE, CONFUSE_RAY, BITE, CONFUSE_RAY
	db 22, CROCONAW,   LEER, POUND, WATER_GUN, BITE
	db -1 ; end
	...
	db 30, HAUNTER,    LICK, MEAN_LOOK, CURSE, SHADOW_BALL
	db 32, SNEASEL,    LEER, QUICK_ATTACK, SCREECH, FAINT_ATTACK
	db 32, QUILAVA,    POUND, EMBER, QUICK_ATTACK, FLAME_WHEEL
	db -1 ; end
	...
	db 30, HAUNTER,    LICK, MEAN_LOOK, CURSE, SHADOW_BALL
	db 32, SNEASEL,    LEER, QUICK_ATTACK, SCREECH, FAINT_ATTACK
	db 32, FERALIGATR, POUND, WATER_GUN, BITE, SCARY_FACE
	db -1 ; end
	...
	db 35, HAUNTER,    MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 35, KADABRA,    DISABLE, PSYBEAM, RECOVER, FUTURE_SIGHT
	db 38, TYPHLOSION, POUND, EMBER, QUICK_ATTACK, FLAME_WHEEL
	db -1 ; end
	...
	db 35, HAUNTER,    MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 35, KADABRA,    DISABLE, PSYBEAM, RECOVER, FUTURE_SIGHT
	db 38, FERALIGATR, POUND, WATER_GUN, SCARY_FACE, SLASH
	db -1 ; end
...
WillGroup:
	...
	db 41, JYNX,       FURY_ATTACK, HYPNOSIS, ICE_PUNCH, PSYCHIC_M
	db 41, EXEGGUTOR,  REFLECT, LEECH_SEED, BODY_SLAM, PSYCHIC_M
...
BrunoGroup:
	...
	db 46, MACHAMP,    ROCK_SLIDE, FORESIGHT, DRAIN_PUNCH, ROCK_SMASH
	db -1 ; end

KarenGroup:
	; KAREN (1)
	db "KAREN@", TRAINERTYPE_MOVES
	db 42, UMBREON,    TOXIC, CONFUSE_RAY, FAINT_ATTACK, MEAN_LOOK
	db 42, VILEPLUME,  STUN_SPORE, ACID, RECOVER, PETAL_DANCE
	db 45, GENGAR,     LICK, TOXIC, CURSE, DESTINY_BOND
	db 44, MURKROW,    QUICK_ATTACK, WING_ATTACK, PURSUIT, FAINT_ATTACK
...
KogaGroup:
	...
	db 42, MUK,        CRUNCH, BARRIER, SLUDGE_BOMB, TOXIC
...
ChampionGroup:
	...
	db 44, GYARADOS,   REVERSAL, RAIN_DANCE, SURF, HYPER_BEAM
...
BrockGroup:
	...
	db 44, ONIX,       WRAP, ROCK_SLIDE, EARTHQUAKE, SANDSTORM
	db 42, KABUTOPS,   SLASH, SURF, SWORDS_DANCE, GIGA_DRAIN
	db -1 ; end
...
LtSurgeGroup:
	...
	db 40, MAGNETON,   FLASH_CANNON, DOUBLE_TEAM, SWIFT, ZAP_CANNON
	db 40, ELECTRODE,  SCREECH, DOUBLE_TEAM, SWIFT, EXPLOSION
...
ScientistGroup:
	...
	db 30, PORYGON,    PSYCH_UP, FLASH, RECOVER, TRI_ATTACK
	db -1 ; end
...
ErikaGroup:
	...
	db 41, JUMPLUFF,   MEGA_DRAIN, LEECH_SEED, SCARY_FACE, GIGA_DRAIN
	db 46, VICTREEBEL, SUNNY_DAY, RECOVER, ACID, RAZOR_LEAF
	db 46, BELLOSSOM,  SUNNY_DAY, RECOVER, PETAL_DANCE, SOLARBEAM
	db -1 ; end

YoungsterGroup:
	; YOUNGSTER (1)
	db "JOEY@", TRAINERTYPE_NICKNAME | TRAINERTYPE_DVS | TRAINERTYPE_ITEM_MOVES
	db  8, RATTATA, "SQUEAKER@"
		db PERFECT_DV, PERFECT_DV
		db BERRY, BITE, LEER, QUICK_ATTACK, FOCUS_ENERGY
	db -1 ; end
	...
	db 13, EXEGGCUTE
		dw LV10_STAT_EXP, LV10_STAT_EXP, LV10_STAT_EXP, LV10_STAT_EXP, LV10_STAT_EXP
	db 13, MANKEY
		dw LV10_STAT_EXP, LV10_STAT_EXP, LV10_STAT_EXP, LV10_STAT_EXP, LV10_STAT_EXP
	db 13, GEODUDE
		dw LV10_STAT_EXP, LV10_STAT_EXP, LV10_STAT_EXP, LV10_STAT_EXP, LV10_STAT_EXP
	...
	; YOUNGSTER (4)
	db "GORDON@", TRAINERTYPE_STAT_EXP | TRAINERTYPE_MOVES
	db 14, CYNDAQUIL
		dw LV10_STAT_EXP, LV10_STAT_EXP, LV10_STAT_EXP, LV10_STAT_EXP, LV10_STAT_EXP
		db POUND, EMBER, SAND_TOMB, GROWL
	db 14, BULBASAUR
		dw LV10_STAT_EXP, LV10_STAT_EXP, LV10_STAT_EXP, LV10_STAT_EXP, LV10_STAT_EXP
		db POUND, GROWL, VINE_WHIP, MAGNITUDE
	db 14, WOOPER
		dw LV10_STAT_EXP, LV10_STAT_EXP, LV10_STAT_EXP, LV10_STAT_EXP, LV10_STAT_EXP
		db WATER_GUN, MUD_SLAP, HAZE, MIST
	db -1 ; end
	...
	db 21, RATICATE,   LEER, QUICK_ATTACK, BITE, SCARY_FACE
	db -1 ; end
	...
	; YOUNGSTER (13)
	db "JOEY@", TRAINERTYPE_MOVES
	db 30, RATICATE,   LEER, QUICK_ATTACK, BITE, PURSUIT
	db -1 ; end

	; YOUNGSTER (14)
	db "JOEY@", TRAINERTYPE_MOVES
	db 37, RATICATE,   HYPER_BEAM, QUICK_ATTACK, BITE, PURSUIT
	db -1 ; end
...
SchoolboyGroup:
	...
	db 38, MAGNETON,   ZAP_CANNON, THUNDER_WAVE, FLASH_CANNON, SWIFT
	db -1 ; end
...
BirdKeeperGroup:
	...
	db 38, PIDGEOT,    TOXIC, QUICK_ATTACK, WING_ATTACK, FLY
...
LassGroup:
	...
	db 18, PSYDUCK,    POUND, LEER, DISABLE, CONFUSION
	db -1 ; end
	...
	db 21, PSYDUCK,    POUND, LEER, DISABLE, CONFUSION
	db -1 ; end

	; LASS (15)
	db "DANA@", TRAINERTYPE_MOVES
	db 29, PSYDUCK,    POUND, DISABLE, CONFUSION, SCREECH
	db 29, AMPHAROS,   POUND, THUNDERSHOCK, THUNDER_WAVE, SCARY_FACE
	db -1 ; end

	; LASS (16)
	db "DANA@", TRAINERTYPE_MOVES
	db 32, PSYDUCK,    POUND, DISABLE, CONFUSION, SCREECH
	db 32, AMPHAROS,   POUND, THUNDERPUNCH, THUNDER_WAVE, SCARY_FACE
	db -1 ; end
...
JanineGroup:
	...
	db 36, CROBAT,     SCREECH, CONFUSE_RAY, CONFUSE_RAY, WING_ATTACK
	db 36, WEEZING,    ACID, SLUDGE_BOMB, TOXIC, EXPLOSION
	db 36, WEEZING,    ACID, SLUDGE_BOMB, TOXIC, EXPLOSION
	db 33, ARIADOS,    SCARY_FACE, GIGA_DRAIN, SCARY_FACE, NIGHT_SHADE
...
CooltrainerMGroup:
	...
	db 26, CHARMANDER, EMBER, POUND, POUND, SCARY_FACE
	...
	db 35, KINGLER,    BUBBLEBEAM, HEADBUTT, SLASH, PROTECT
	db 35, FLAREON,    GROWL, QUICK_ATTACK, BITE, FIRE_SPIN
	db -1 ; end

	; COOLTRAINERM (7)
	db "GAVEN@", TRAINERTYPE_ITEM_MOVES
	db 39, VICTREEBEL, NO_ITEM,      GIGA_DRAIN, TOXIC, SLUDGE_BOMB, RAZOR_LEAF
	db 39, KINGLER,    KINGS_ROCK,   SURF, HEADBUTT, SLASH, BLIZZARD
	db 39, FLAREON,    NO_ITEM,      FLAMETHROWER, QUICK_ATTACK, BITE, FIRE_SPIN
	db -1 ; end

	; COOLTRAINERM (8)
	db "RYAN@", TRAINERTYPE_MOVES
	db 25, PIDGEOT,    POUND, QUICK_ATTACK, GUST, WING_ATTACK
	...
	db 32, KINGLER,    BUBBLEBEAM, HEADBUTT, SLASH, PROTECT
	db 32, FLAREON,    LEER, QUICK_ATTACK, BITE, FIRE_SPIN
	db -1 ; end
	...
	db 35, SANDSLASH,  LEER, POISON_STING, SLASH, SWIFT
	db -1 ; end
	...
	db 27, CHARMELEON, EMBER, POUND, POUND, SCARY_FACE
	db -1 ; end

	; COOLTRAINERM (20)
	db "DARIN@", TRAINERTYPE_MOVES
	db 37, DRAGONAIR,  WRAP, SURF, DRAGON_CLAW, BODY_SLAM
	db -1 ; end
...
CooltrainerFGroup:
	...
	db 25, SKIPLOOM,   RECOVER, POISONPOWDER, MEGA_DRAIN, LEECH_SEED
	...
	db 36, RAPIDASH,   HEADBUTT, FIRE_SPIN, FURY_ATTACK, AGILITY
	db -1 ; end
	...
	; COOLTRAINERF (12)
	db "BETH@", TRAINERTYPE_MOVES
	db 39, RAPIDASH,   HEADBUTT, FIRE_SPIN, FURY_ATTACK, AGILITY
	db -1 ; end
	...
	db 25, BUTTERFREE, CONFUSION, SLEEP_POWDER, PSYBEAM, GUST
	...
	db 43, RAPIDASH,   FOCUS_BAND,   HEADBUTT, FIRE_SPIN, FURY_ATTACK, FIRE_BLAST
	db -1 ; end
	...
	db 33, HORSEA,     POUND, LEER, WHIRLPOOL, TWISTER
	db 33, HORSEA,     POUND, LEER, WHIRLPOOL, TWISTER
...
BeautyGroup:
	...
	db 16, MEOWTH,     POUND, GROWL, BITE, FAIRY_WIND
	db 16, MEOWTH,     POUND, GROWL, BITE, SLASH
	db -1 ; end
	...
	db 17, HOPPIP,     RECOVER, LEER, POUND, POISONPOWDER
	db 17, SKIPLOOM,   RECOVER, LEER, POUND, STUN_SPORE
	db -1 ; end
...
PokemaniacGroup:
	...
	db 36, PORYGON,    RECOVER, PSYCHIC_M, FLASH, TRI_ATTACK
	db -1 ; end
	...
	; POKEMANIAC (14)
	db "BRENT@", TRAINERTYPE_MOVES
	db 41, CHANSEY,    ROLLOUT, ATTRACT, BODY_SLAM, RECOVER
	db -1 ; end
...
GruntMGroup:
	...
	db 15, ELEKID
		dw LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP
		db MAGNET, FLASH, THUNDER_WAVE, HIDDEN_POWER, SWIFT
	db 15, ODDISH
		dw LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP
		db ROCKY_HELMET, SNARL, STUN_SPORE, ACID, ABSORB
	db 15, HORSEA
		dw LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP
		db SCOPE_LENS, BUBBLEBEAM, FOCUS_ENERGY, HIDDEN_POWER, SWIFT
	db 15, VOLTORB
		dw LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP
		db FOCUS_SASH, SONICBOOM, STUN_SPORE, FLASH, BULLET_SEED
	db -1 ; end
	...
	db 15, EKANS
		dw LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP
		db POISON_BARB, POISON_TAIL, GLARE, BITE, WRAP
	db 15, DROWZEE
		dw LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP
		db BERRY_JUICE, CONFUSION, KARATE_CHOP, HYPNOSIS, DISABLE
	db 15, RATTATA
		dw LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP
		db BLACKGLASSES, BITE, SUPER_FANG, QUICK_ATTACK, FOCUS_ENERGY
	db 15, ZUBAT
		dw LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP
		db BERRY_JUICE, CONFUSE_RAY, WING_ATTACK, ABSORB, POISON_STING
	db -1 ; end
...
SabrinaGroup:
	...
	db 46, ESPEON,     LEER, QUICK_ATTACK, SWIFT, PSYCHIC_M
...
BugCatcherGroup:
	...
	; BUG_CATCHER (5)
	db "BENNY@", TRAINERTYPE_STAT_EXP | TRAINERTYPE_MOVES
	db 16, KABUTO
		dw LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP
		db VICEGRIP, ROCK_THROW, LEER
	db 16, PINECO
		dw LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP
		db PROTECT, CURSE, SHADOW_SNEAK, ROLLOUT
	db 16, DIGLETT
		dw LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP
		db PURSUIT, MAGNITUDE, ROCK_SMASH, DOUBLE_TEAM
	db 16, PORYGON
		dw LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP
		db FLASH, DISABLE, POWDER_SNOW, PSYBEAM
	db -1 ; end
	...
	db 14, WEEDLE
		dw LV10_STAT_EXP, LV10_STAT_EXP, LV10_STAT_EXP, LV10_STAT_EXP, LV10_STAT_EXP
		db POISON_STING, SCARY_FACE, VICEGRIP
	db 14, CATERPIE
		dw LV10_STAT_EXP, LV10_STAT_EXP, LV10_STAT_EXP, LV10_STAT_EXP, LV10_STAT_EXP
		db POUND, SCARY_FACE, STRUGGLE_BUG
	db 14, LEDYBA
		dw LV10_STAT_EXP, LV10_STAT_EXP, LV10_STAT_EXP, LV10_STAT_EXP, LV10_STAT_EXP
		db POUND, MACH_PUNCH, CONFUSE_RAY, LIGHT_SCREEN
	db 14, SPINARAK
		dw LV10_STAT_EXP, LV10_STAT_EXP, LV10_STAT_EXP, LV10_STAT_EXP, LV10_STAT_EXP
		db POISON_STING, SCARY_FACE, PURSUIT, TOXIC
	db 14, PARAS
		dw LV10_STAT_EXP, LV10_STAT_EXP, LV10_STAT_EXP, LV10_STAT_EXP, LV10_STAT_EXP
		db POUND, CURSE, STUN_SPORE, RAZOR_LEAF
	db 14, VENONAT
		dw LV10_STAT_EXP, LV10_STAT_EXP, LV10_STAT_EXP, LV10_STAT_EXP, LV10_STAT_EXP
		db DISABLE, CONFUSION, STRUGGLE_BUG, CONFUSE_RAY
	db -1 ; end
	...
	db 18, KAKUNA
		dw LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP
		db DEFENSE_CURL, POISON_TAIL, VICEGRIP, SCARY_FACE
	db 18, METAPOD
		dw LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP
		db DEFENSE_CURL, STRUGGLE_BUG, CONFUSION, SCARY_FACE
	db 15, PUPITAR
		dw LV10_STAT_EXP, LV10_STAT_EXP, LV10_STAT_EXP, LV10_STAT_EXP, LV10_STAT_EXP
		db DEFENSE_CURL, ROCK_THROW, BITE, SCARY_FACE
	db -1 ; end
	...
	db 24, BUTTERFREE, CONFUSION, POISONPOWDER, CONFUSE_RAY, STRUGGLE_BUG
	db 24, BUTTERFREE, CONFUSION, STUN_SPORE, CONFUSE_RAY, STRUGGLE_BUG
	db 25, BEEDRILL,   FURY_ATTACK, FOCUS_ENERGY, TWINEEDLE, POUND
	db 24, BUTTERFREE, CONFUSION, SLEEP_POWDER, CONFUSE_RAY, STRUGGLE_BUG
	db -1 ; end
	...
	db 34, BUTTERFREE, PSYBEAM, SLEEP_POWDER, GUST, STRUGGLE_BUG
	db -1 ; end
...
FisherGroup:
	...
	db 15, GYARADOS, LEER, REVERSAL, BITE, TAIL_SWIPE
	db -1 ; end

	; FISHER (2)
	db "RALPH@", TRAINERTYPE_MOVES
	db 16, QWILFISH, SPIKES, POISON_TAIL, SPIKE_CANNON, DEFENSE_CURL
	db -1 ; end
	...
	db 25, REMORAID,   BULLET_SEED, PSYBEAM, AURORA_BEAM, BUBBLEBEAM
	db 25, REMORAID,   BULLET_SEED, PSYBEAM, AURORA_BEAM, BUBBLEBEAM
	db -1 ; end
	...
	db 34, SEAKING,    CONFUSE_RAY, WATERFALL, REVERSAL, FURY_ATTACK
	db 34, SEAKING,    CONFUSE_RAY, WATERFALL, REVERSAL, FURY_ATTACK
	...
	; FISHER (24)
	db "RALPH@", TRAINERTYPE_MOVES
	db 35, QWILFISH,   TOXIC, POISON_JAB, SURF, PIN_MISSILE
	db 39, SEAKING,    PLAY_ROUGH, REVERSAL, FURY_ATTACK, WATERFALL
	db -1 ; end

	; FISHER (25)
	db "TULLY@", TRAINERTYPE_MOVES
	db 34, SEAKING,    CONFUSE_RAY, RAIN_DANCE, WATERFALL, FURY_ATTACK
	db 34, SEAKING,    CONFUSE_RAY, RAIN_DANCE, WATERFALL, FURY_ATTACK
...
SwimmerFGroup:
	...
	db 20, PSYDUCK,    POUND, LEER, DISABLE, CONFUSION
	db 22, GOLDEEN,    PECK, LEER, CONFUSE_RAY, AQUA_JET
	db -1 ; end
	...
	db 21, HORSEA,     BUBBLEBEAM, POUND, LEER, WATER_GUN
	db 21, HORSEA,     DRAGON_CLAW, POUND, LEER, WATER_GUN
	db -1 ; end
...
SailorGroup:
	...
	db 38, POLIWRATH,  SURF, STRENGTH, ICE_PUNCH, DRAIN_PUNCH
	db -1 ; end
...
SuperNerdGroup:
	...
	db 39, SEADRA,     POUND, TWISTER, SURF, WATERFALL
	db -1 ; end
...
Rival2Group:
	...
	db 43, GENGAR,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 43, ALAKAZAM,   DISABLE, RECOVER, FUTURE_SIGHT, PSYCHIC_M
	db 45, TYPHLOSION, POUND, QUICK_ATTACK, FLAME_WHEEL, SWIFT
	db -1 ; end
	...
	db 43, GENGAR,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 43, ALAKAZAM,   DISABLE, RECOVER, FUTURE_SIGHT, PSYCHIC_M
	db 45, FERALIGATR, POUND, WATER_GUN, SCARY_FACE, SLASH
	db -1 ; end
	...
	db 46, GENGAR,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 46, ALAKAZAM,   RECOVER, FUTURE_SIGHT, PSYCHIC_M, REFLECT
	db 50, TYPHLOSION, POUND, QUICK_ATTACK, FIRE_BLAST, SWIFT
	db -1 ; end
...
HikerGroup:
	...
	db 16, GEODUDE
		dw LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP
		db SPARK, ROCK_THROW, DEFENSE_CURL, ROLLOUT
	db 16, MACHOP
		dw LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP
		db MACH_PUNCH, KARATE_CHOP, FOCUS_ENERGY, FIRE_PUNCH
	db -1 ; end
	...
	db 27, DIGLETT,    MAGNITUDE, DIG, LEER, SLASH
	db 27, DUGTRIO,    MAGNITUDE, DIG, LEER, SLASH
	db -1 ; end
...
BlaineGroup:
	...
	db 45, MAGCARGO,   CURSE, ACID, FLAMETHROWER, ROCK_SLIDE
...
BurglarGroup:
	...
	db 24, KOFFING,    POUND, ACID, SLUDGE, TOXIC
	db -1 ; end
...
BlackbeltGroup:
	...
	db 27, HITMONLEE,  DOUBLE_KICK, MEDITATE, HI_JUMP_KICK, FOCUS_ENERGY
	db -1 ; end

	; BLACKBELT_T (3)
	db "KENJI@", TRAINERTYPE_MOVES
	db 33, ONIX,       WRAP, ROCK_THROW, TOXIC, DIG
	db 38, MACHAMP,    HEADBUTT, SWAGGER, THUNDERPUNCH, DYNAMICPUNCH
	...
	db 27, HITMONCHAN, POUND, THUNDERPUNCH, ICE_PUNCH, FIRE_PUNCH
	db -1 ; end
...
ExecutiveMGroup:
	...
	db 33, KOFFING,    POUND, SLUDGE, TOXIC, HAZE
	db 35, HOUNDOOM,   EMBER, ACID, BITE, FAINT_ATTACK
	db -1 ; end
	...
	; EXECUTIVEM (3)
	db "EXECUTIVE@", TRAINERTYPE_MOVES
	db 30, KOFFING,    POUND, EXPLOSION, SLUDGE, TOXIC
	db 30, KOFFING,    POUND, EXPLOSION, SLUDGE, TOXIC
	db 30, KOFFING,    POUND, EXPLOSION, SLUDGE, TOXIC
	db 32, WEEZING,    POUND, EXPLOSION, SLUDGE, TOXIC
	db 30, KOFFING,    POUND, EXPLOSION, SLUDGE, TOXIC
	db 30, KOFFING,    POUND, ACID, SLUDGE, TOXIC
	db -1 ; end
	...
	db 16, ZUBAT
		db PERFECT_DV, PERFECT_DV
		dw LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP
		db BERRY_JUICE, WING_ATTACK, ABSORB, BITE, CONFUSE_RAY
	db 16, NIDORAN_M
		db PERFECT_DV, PERFECT_DV
		dw LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP
		db BERRY_JUICE, POISON_TAIL, DOUBLE_KICK, FOCUS_ENERGY, DIG
	db 16, GRIMER
		db PERFECT_DV, PERFECT_DV
		dw LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP
		db BERRY_JUICE, POISON_TAIL, BITE, DISABLE, TOXIC
	db 16, KOFFING
		db $cf, $8f
		dw LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP
		db BERRY_JUICE, WILL_O_WISP, ACID, FAIRY_WIND, HIDDEN_POWER
	db -1
...
PsychicGroup:
	...
	db 13, ABRA,       TELEPORT, FLASH, NO_MOVE, NO_MOVE
	db 15, KADABRA,    TELEPORT, GROWL, CONFUSION, NO_MOVE
	db -1 ; end
...
PicnickerGroup:
	...
	db 31, CLEFAIRY,   ENCORE, HYPNOSIS, FURY_ATTACK, DEFENSE_CURL
	db -1 ; end

	; PICNICKER (17)
	db "TIFFANY@", TRAINERTYPE_MOVES
	db 37, CLEFAIRY,   ENCORE, FURY_ATTACK, DEFENSE_CURL, METRONOME
	db -1 ; end
	...
	; PICNICKER (20)
	db "TIFFANY@", TRAINERTYPE_MOVES
	db 20, CLEFAIRY,   ENCORE, HYPNOSIS, FURY_ATTACK, DEFENSE_CURL
	db -1 ; end

	; PICNICKER (21)
	db "ERIN@", TRAINERTYPE_MOVES
	db 36, PONYTA,     DOUBLE_TEAM, HEADBUTT, FIRE_SPIN, SUNNY_DAY
	...
	db 33, JUMPLUFF,   STUN_SPORE, SUNNY_DAY, LEECH_SEED, SCARY_FACE
	db 33, JUMPLUFF,   SUNNY_DAY, SLEEP_POWDER, LEECH_SEED, SCARY_FACE
	db 38, VENUSAUR,   SOLARBEAM, RAZOR_LEAF, HEADBUTT, MUD_SLAP
	db -1 ; end

	; PICNICKER (26)
	db "TIFFANY@", TRAINERTYPE_MOVES
	db 43, CLEFAIRY,   METRONOME, ENCORE, RECOVER, DEFENSE_CURL
	db -1 ; end
...
CamperGroup:
	...
	db 33, GRAVELER,   EXPLOSION, ROCK_THROW, DEFENSE_CURL, MAGNITUDE
	db 33, GRAVELER,   EXPLOSION, ROCK_THROW, DEFENSE_CURL, MAGNITUDE
...
SageGroup:
	...
	; SAGE (3)
	db "JIN@", TRAINERTYPE_DVS
	db  6, UNOWN, $fc, $8f				;psychic
	db  6, UNOWN, PERFECT_DV, $8f		;dark
	db  6, UNOWN, $cc, $8f				;fighting
	db  6, UNOWN, $ec, $8f				;fire
	db  6, UNOWN, $ed, $8f				;water
	db  6, UNOWN, $ee, $8f				;grass
	db -1 ; end
	...
	; SAGE (9)
	db "LI@", TRAINERTYPE_DVS | TRAINERTYPE_STAT_EXP | TRAINERTYPE_ITEM_MOVES
	db 11, BELLSPROUT
		db $cf, $8f		;ground
		dw LV10_STAT_EXP, LV10_STAT_EXP, LV10_STAT_EXP, LV10_STAT_EXP, LV10_STAT_EXP
		db BERRY
		db VINE_WHIP, GROWTH, WRAP, HIDDEN_POWER
	db 11, GASTLY
		db $cc, $8f		;fighting
		dw LV10_STAT_EXP, LV10_STAT_EXP, LV10_STAT_EXP, LV10_STAT_EXP, LV10_STAT_EXP
		db BERRY
		db HYPNOSIS, LICK, CONFUSE_RAY, HIDDEN_POWER
	db 11, LARVITAR
		db $cd, $8f		;flying
		dw LV10_STAT_EXP, LV10_STAT_EXP, LV10_STAT_EXP, LV10_STAT_EXP, LV10_STAT_EXP
		db BERRY
		db ROCK_THROW, LEER, BITE, HIDDEN_POWER
	db -1 ; end
...
TwinsGroup:
	; TWINS (1)
	db "AMY & MAY@", TRAINERTYPE_STAT_EXP | TRAINERTYPE_ITEM_MOVES
	db 16, ARIADOS
		dw LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP
		db SCOPE_LENS, POISON_STING, MEAN_LOOK, PIN_MISSILE, DIG
	db 16, LEDIAN
		dw LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP
		db PUNCH_GLOVES, MACH_PUNCH, WING_ATTACK, REFLECT, CONFUSE_RAY
	db -1 ; end

	; TWINS (2)
	db "ANN & ANNE@", TRAINERTYPE_MOVES
	db 16, CLEFAIRY,   GROWL, ENCORE, FURY_ATTACK, METRONOME
...
RedGroup:
	...
	db 77, VENUSAUR,   SUNNY_DAY, GIGA_DRAIN, RECOVER, SOLARBEAM
...
BlueGroup:
	...
	db 56, PIDGEOT,    QUICK_ATTACK, HYPER_VOICE, WING_ATTACK, OVERHEAT
	...
	db 58, EXEGGUTOR,  SUNNY_DAY, LEECH_SEED, BODY_SLAM, SOLARBEAM
...
GruntFGroup:
	...
	db 15, SNUBBULL
		dw LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP
		db SOFT_SAND, MAGNITUDE, CHARM, COVET, BITE
	db 15, ABRA
		dw LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP
		db TWISTEDSPOON, THUNDER_WAVE, ZAP_CANNON, HIDDEN_POWER, DOUBLE_TEAM
	db 15, SMOOCHUM
		dw LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP
		db FOCUS_SASH, CONFUSION, POWDER_SNOW, CONFUSE_RAY, HYPNOSIS
	db 15, MEOWTH
		dw LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP, LV15_STAT_EXP
		db BERRY_JUICE, METAL_CLAW, BITE, FURY_ATTACK, LEER
	db -1 ; end
