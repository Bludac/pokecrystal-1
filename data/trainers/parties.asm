...
MortyGroup:
	...
	db 23, HAUNTER,    SPITE, MEAN_LOOK, SHADOW_BALL, NIGHT_SHADE
	db -1 ; end
...
BrunoGroup:
	...
	db 46, MACHAMP,    ROCK_SLIDE, FORESIGHT, VITAL_THROW, ROCK_SMASH
	db -1 ; end
...
KarenGroup:
	...
	db 42, VILEPLUME,  STUN_SPORE, ACID, MORNING_SUN, PETAL_DANCE
...
SchoolboyGroup:
	...
	db 37, VILEPLUME,  SOLARBEAM, SLEEP_POWDER, ACID, MORNING_SUN
	db -1 ; end
...
CooltrainerMGroup:
	...
	db 35, KINGLER,    BUBBLEBEAM, STOMP, SLASH, PROTECT
	...
	db 39, KINGLER,    KINGS_ROCK,   SURF, STOMP, SLASH, BLIZZARD
	...
	db 32, KINGLER,    BUBBLEBEAM, STOMP, SLASH, PROTECT
...
BeautyGroup:
	...
	db 17, HOPPIP,     MORNING_SUN, LEER, POUND, POISONPOWDER
	db 17, SKIPLOOM,   MORNING_SUN, LEER, POUND, STUN_SPORE
	db -1 ; end
...
PokemaniacGroup:
	...
	; POKEMANIAC (14)
	db "BRENT@", TRAINERTYPE_MOVES
	db 41, CHANSEY,    ROLLOUT, ATTRACT, BODY_SLAM, SOFTBOILED
	db -1 ; end
...
PicnickerGroup:
	...
	; PICNICKER (26)
	db "TIFFANY@", TRAINERTYPE_MOVES
	db 43, CLEFAIRY,   METRONOME, ENCORE, MORNING_SUN, DEFENSE_CURL
	db -1 ; end
...
RedGroup:
	...
	db 77, VENUSAUR,   SUNNY_DAY, GIGA_DRAIN, MORNING_SUN, SOLARBEAM
