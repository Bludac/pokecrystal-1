...
; BattleTowerMons group 2
	...
	db GYARADOS
	db MIRACLEBERRY
	db HYPER_BEAM, DRAGON_CLAW, THUNDERBOLT, FIRE_BLAST
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db BLISSEY
	db BRIGHTPOWDER
	db PSYCHIC_M, DRAIN_PUNCH, RECOVER, COUNTER
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db HITMONCHAN
	db GOLD_BERRY
	db THUNDERPUNCH, ICE_PUNCH, FIRE_PUNCH, BODY_SLAM
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 50000
...
; BattleTowerMons group 3
	...
	db POLIWRATH
	db BRIGHTPOWDER
	db DOUBLE_TEAM, SURF, EARTHQUAKE, DRAIN_PUNCH
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db MACHAMP
	db MIRACLEBERRY
	db ROCK_SMASH, ICE_PUNCH, EARTHQUAKE, FIRE_BLAST
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db FEAROW
	db BRIGHTPOWDER
	db DRILL_PECK, PURSUIT, PECK, SWIFT
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 30000
...
; BattleTowerMons group 4
	...
	db PORYGON2
	db NO_ITEM
	db FLASH, PSYCH_UP, PSYBEAM, THIEF
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db EXEGGUTOR
	db BRIGHTPOWDER
	db BODY_SLAM, HEADBUTT, PSYCH_UP, CONFUSION
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 50000
...
; BattleTowerMons group 5
	...
	db MACHAMP
	db GOLD_BERRY
	db ROCK_SMASH, EARTHQUAKE, FIRE_BLAST, THUNDERPUNCH
	dw 0 ; OT ID
	dt 125000 ; Exp
	; Stat exp
	bigdw 40000
...
; BattleTowerMons group 6
	...
	db MACHAMP
	db QUICK_CLAW
	db FIRE_PUNCH, ROCK_SMASH, THUNDERPUNCH, EARTHQUAKE
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 50000
...
; BattleTowerMons group 7
	...
	db PRIMEAPE
	db QUICK_CLAW
	db ROCK_SMASH, ICE_PUNCH, THUNDERPUNCH, ROCK_SLIDE
	dw 0 ; OT ID
	dt 343000 ; Exp
	; Stat exp
	bigdw 50000
...
; BattleTowerMons group 8
	...
	db PINSIR
	db GOLD_BERRY
	db HYPER_BEAM, DRAIN_PUNCH, STRENGTH, TOXIC
	dw 0 ; OT ID
	dt 512000 ; Exp
	; Stat exp
	bigdw 30000
...
; BattleTowerMons group 9
	...
	db MACHAMP
	db QUICK_CLAW
	db ROCK_SMASH, DYNAMICPUNCH, FIRE_BLAST, EARTHQUAKE
	dw 0 ; OT ID
	dt 729000 ; Exp
	; Stat exp
	bigdw 55000
...
; BattleTowerMons group 10
	...
	db MACHAMP
	db QUICK_CLAW
	db ROCK_SMASH, EARTHQUAKE, HYPER_BEAM, DYNAMICPUNCH
	dw 0 ; OT ID
	dt 1000000 ; Exp
	; Stat exp
	bigdw 60000
