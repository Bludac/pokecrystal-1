...
INCLUDE "engine/battle/move_effects/draco.asm"

INCLUDE "engine/battle/move_effects/close_combat.asm"

INCLUDE "engine/battle/move_effects/hammer.asm"
...
INCLUDE "engine/battle/move_effects/work_up.asm"
