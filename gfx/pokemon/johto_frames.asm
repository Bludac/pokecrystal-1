...
LugiaFrames:      INCLUDE "gfx/pokemon/arcalight/frames.asm"
HoOhFrames:       INCLUDE "gfx/pokemon/freezing/frames.asm"
CelebiFrames:     INCLUDE "gfx/pokemon/wyrdeer/frames.asm"
