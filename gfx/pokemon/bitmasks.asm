...
LugiaBitmasks:      INCLUDE "gfx/pokemon/arcalight/bitmask.asm"
HoOhBitmasks:       INCLUDE "gfx/pokemon/freezing/bitmask.asm"
CelebiBitmasks:     INCLUDE "gfx/pokemon/wyrdeer/bitmask.asm"
