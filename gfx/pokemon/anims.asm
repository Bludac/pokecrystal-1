...
LugiaAnimation:      INCLUDE "gfx/pokemon/arcalight/anim.asm"
HoOhAnimation:       INCLUDE "gfx/pokemon/freezing/anim.asm"
CelebiAnimation:     INCLUDE "gfx/pokemon/wyrdeer/anim.asm"
