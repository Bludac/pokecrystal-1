...
LugiaAnimationIdle:      INCLUDE "gfx/pokemon/arcalight/anim_idle.asm"
HoOhAnimationIdle:       INCLUDE "gfx/pokemon/freezing/anim_idle.asm"
CelebiAnimationIdle:     INCLUDE "gfx/pokemon/wyrdeer/anim_idle.asm"
