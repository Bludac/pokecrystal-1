; MoveEffectsPointers indexes (see data/moves/effects_pointers.asm)
	...
	const EFFECT_SPIRIT_BOMB
	const EFFECT_RETURN
	const EFFECT_STRONG_WINDS
	const EFFECT_UNUSED_7B
